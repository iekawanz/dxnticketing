...
{
  header('location:'.HTTP_SERVER.'ticketing/index.php');
  exit;
}
?>
<!doctype html>
...
<body>
  ...
  <div class="wrapper-login d-flex">
    <div class="col-left w-100" style="background-image:url(images/main3.jpg);">

      <div class="centering">
        <img src="images/logo-dxnnwn-white.png" alt="" class="img-logo">
        <h4 class="white">Customer Support Ticketing System</h4>
        <div class="layer-login">
          <div class="form-general">
            ...
            <div class="password">
                ...
                <span class="material-symbols-outlined icon-password" id="eyePassword">visibility_off</span>
            </div>
            <small class="d-block text-end pe-4 lh-1 text-danger" id="password_error">&nbsp;</small>
          </div>
  
          <button id="btnLogin" type="button" class="btn-blue w-100 mt-5">LOGIN</button>
        </div>
      </div>
